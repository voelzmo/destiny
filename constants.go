...
const (
	...
	ConsulEncryptKey = "Twas brillig, and the slithy toves Did gyre and gimble in the wabe; All mimsy were the borogoves, And the mome raths outgrabe."
	ConsulEncrypt    = "Atzo3VBv+YVDzQAzlQRPRA=="

	ConsulAgentKey = `-----BEGIN RSA PRIVATE KEY-----
...
`
	...
	ConsulAgentCert = `-----BEGIN CERTIFICATE-----
...
`
	...
	ConsulServerKey = `-----BEGIN RSA PRIVATE KEY-----
...
`
	...
	ConsulServerCert = `-----BEGIN CERTIFICATE-----
...
`
	...
	ConsulCACert = `-----BEGIN CERTIFICATE-----
